...
const Basic = () => {
  ...
  const [chart2Range, setChart2Range] = useState(null);
  ...
  const handleMainChartResize = (event, { element, size, handle }) => {
    ...
    myChart2?.applyOptions({
      width: size.width,
    });
  };
  // main chart code ends
  ...
  useEffect(() => {
    ...
    const newSeries = chart2.addCandlestickSeries();
  ...
  useEffect(() => {
    if (chartRange) {
      myChart2?.timeScale().setVisibleLogicalRange(chartRange);
    }
  }, [chartRange, myChart2]);
  ...
  return (
    ...
    >
      <ResizableBox
        ...
        width={document.documentElement.clientWidth * 0.85}
        minConstraints={[document.documentElement.clientWidth * 0.65, 100]}
        maxConstraints={[
          document.documentElement.clientWidth * 0.85,
